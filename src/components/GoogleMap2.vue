...
export default {
  ...
  methods: {
    getGeoByAddress(e) {
      ...
      var get = axios
        .get(
          `https://maps.googleapis.com/maps/api/geocode/json?address=${this
            .searchPosition}&key=AIzaSyBMPwmpKGkNozJfQ2zrVZdvlvJDv7QsZrM`
        )
        .then(res => {
          ...
          var markerIcon = {
            url:
              "https://raw.githubusercontent.com/google/material-design-icons/master/maps/drawable-xxxhdpi/ic_place_black_48dp.png",
    ...
    showAddress(lat, lng) {
      axios
        .get(
          `https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat},${lng}&key=AIzaSyBMPwmpKGkNozJfQ2zrVZdvlvJDv7QsZrM`
        )
        .then(res => {
